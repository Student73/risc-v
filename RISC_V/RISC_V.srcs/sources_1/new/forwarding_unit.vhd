...
begin
forward_branch:process(rs1_address_id_i,rs2_address_id_i,rd_we_mem_i,rd_address_mem_i)is
             begin
...
forward_alu:process(rd_we_wb_i,rd_address_wb_i,rs1_address_ex_i,rs2_address_ex_i )is
            begin
             alu_forward_a_o<="00";
             alu_forward_b_o<="00";
